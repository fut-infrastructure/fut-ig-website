# Consent Category - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/cs/consent-category | *Version*:10.0.2 |
...
```json
{
  ...
  },
  {
    ...
    "display" : "Behavior by policy",
    "definition" : "Behavior by policy",
    "designation" : [{
      "language" : "da",
      "value" : "Adfærd baseret på policy"
    }]
  }]
}
