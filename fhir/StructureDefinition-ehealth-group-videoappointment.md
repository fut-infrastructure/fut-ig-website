# ehealth-group-videoappointment - eHealth Infrastructure v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-group-videoappointment | *Version*:6.0.0 |
| Active as of 2025-10-23 | *Computable Name*:ehealth-group-videoappointment |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/dk.ehealth.sundhed.fhir.ig.core|current/StructureDefinition/ehealth-group-videoappointment)
