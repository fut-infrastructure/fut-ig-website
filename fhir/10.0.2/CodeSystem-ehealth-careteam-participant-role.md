# CareTeam Participant Role - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/cs/careteam-participant-role | *Version*:10.0.2 |
...
```json
{
  ...
  {
    "code" : "clinicalPlanAdministrator",
    "display" : "Clinical Plan Administrator",
    "definition" : "Clinical Plan Administrator",
    "designation" : [{
      "language" : "da",
