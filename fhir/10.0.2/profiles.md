# Profiles - eHealth Infrastructure v10.0.2
...
The following [Extensions](http://hl7.org/fhir/R4/extensibility.html) have been defined as part of this implementation Guide. A [registry of standard extensions](http://hl7.org/fhir/R4/extensibility-registry.html) can be found in the FHIR specification and additional extensions may be registered on the HL7 FHIR registry at [http://hl7.org/fhir/registry](http://hl7.org/fhir/registry).
...
* [Aggregate Group ID](StructureDefinition-ehealth-aggregate-group-id.md)

* [aggregateId](StructureDefinition-ehealth-aggregate-id.md)

* [Aggregation Mode](StructureDefinition-ehealth-aggregation-mode.md)

* [Answer condition](StructureDefinition-ehealth-answer-Condition.md)

* [Artifact Date](StructureDefinition-ehealth-artifact-date.md)

* [Assigning careteam](StructureDefinition-ehealth-assigning-careteam.md)

* [Base environment](StructureDefinition-ehealth-base-environment.md)

* [Base](StructureDefinition-ehealth-base.md)

* [Title](StructureDefinition-ehealth-basic-title.md)

* [DateTime Extension](StructureDefinition-ehealth-carecommunication-datetime.md)

* [Destination Extension](StructureDefinition-ehealth-carecommunication-destination.md)

* [Message type](StructureDefinition-ehealth-carecommunication-message-Type.md)

* [sender organization](StructureDefinition-ehealth-carecommunication-origin.md)

* [Identifier Extension](StructureDefinition-ehealth-carecommunication-payload-identifier.md)

* [Sender Extension, contains the sending PractitionerRole, Practitioner and CareTeam.](StructureDefinition-ehealth-carecommunication-sender.md)
...
* [assessor-Organization](StructureDefinition-ehealth-clinicalimpression-assessor-organization.md)

* [assessor-other](StructureDefinition-ehealth-clinicalimpression-assessor-other.md)

* [Careplan](StructureDefinition-ehealth-clinicalimpression-careplan.md)

* [Decision](StructureDefinition-ehealth-clinicalimpression-decision.md)

* [Decision context](StructureDefinition-ehealth-clinicalimpression-decisionContext.md)

* [Media investigation item](StructureDefinition-ehealth-clinicalimpression-mediaInvestigationItem.md)

* [Other item](StructureDefinition-ehealth-clinicalimpression-otherItem.md)

* [View investigation item](StructureDefinition-ehealth-clinicalimpression-viewInvestigationItem.md)

* [Code Qualification](StructureDefinition-ehealth-code-qualification.md)

* [Recipient careteam](StructureDefinition-ehealth-communication-recipientCareTeam.md)

* [Sender careteam](StructureDefinition-ehealth-communication-senderCareTeam.md)

* [Author organization](StructureDefinition-ehealth-composition-authorOrganization.md)

* [What the consent is related to](StructureDefinition-ehealth-consent-affiliation.md)

* [Content](StructureDefinition-ehealth-content.md)

* [Creator](StructureDefinition-ehealth-creator.md)

* [Description](StructureDefinition-ehealth-description.md)

* [Device platform](StructureDefinition-ehealth-device-platform.md)

* [Privately owned](StructureDefinition-ehealth-device-privatelyOwned.md)

* [Registration token](StructureDefinition-ehealth-device-registrationToken.md)

* [Suppliers](StructureDefinition-ehealth-device-suppliers.md)

* [Calibration expires](StructureDefinition-ehealth-devicemetric-calibrationExpires.md)
...
* [Context](StructureDefinition-ehealth-deviceusestatement-context.md)

* [State of the document sharing](StructureDefinition-ehealth-document-sharing-state.md)

* [effectivePeriod](StructureDefinition-ehealth-effectivePeriod.md)

* [Employee title](StructureDefinition-ehealth-employee-title.md)

* [Condition Id](StructureDefinition-ehealth-enableBehavior-conditionId.md)

* [End meeting on end time](StructureDefinition-ehealth-end-meeting-on-end-time.md)

* [Caremanager organization](StructureDefinition-ehealth-episodeofcare-caremanagerOrganization.md)

* [Status schedule](StructureDefinition-ehealth-episodeofcare-statusschedule.md)

* [Careteam](StructureDefinition-ehealth-ext-careteam.md)

* [ExternalIdentifier](StructureDefinition-ehealth-external-identifier.md)

* [General health condition](StructureDefinition-ehealth-general-health-condition.md)

* [Group id](StructureDefinition-ehealth-group-id.md)

* [Guest PIN code](StructureDefinition-ehealth-guest-pin-code.md)

* [EpisodeOfCare](StructureDefinition-ehealth-guidanceresponse-episodeOfCare.md)

* [Guest PIN code](StructureDefinition-ehealth-host-pin-code.md)

* [includeAsExtra](StructureDefinition-ehealth-include-as-extra.md)

* [Intended audience](StructureDefinition-ehealth-intendedAudience.md)

* [Intended organization](StructureDefinition-ehealth-intendedOrganization.md)
...
* [Managing organization](StructureDefinition-ehealth-managing-organization.md)

* [Ehealth Document manually deprecated](StructureDefinition-ehealth-manuallydeprecated-type.md)

* [Max participants](StructureDefinition-ehealth-max-participants.md)

* [Related to](StructureDefinition-ehealth-media-related-to.md)

* [Series ID](StructureDefinition-ehealth-media-series-id.md)
...
* [Meeting URL](StructureDefinition-ehealth-meeting-url.md)

* [eHealth Message Author](StructureDefinition-ehealth-message-author.md)

* [Modified role](StructureDefinition-ehealth-modifier-role.md)

* [Name and address protection](StructureDefinition-ehealth-nameandaddressprotection.md)

* [Observation method](StructureDefinition-ehealth-observation-method.md)

* [On behalf of](StructureDefinition-ehealth-on-behalf-of.md)

* [CVR Number](StructureDefinition-ehealth-organization-cvrNumber.md)

* [Municipality Code](StructureDefinition-ehealth-organization-municipalityCode.md)

* [Provider identifier](StructureDefinition-ehealth-organization-providerIdentifier.md)

* [Region code](StructureDefinition-ehealth-organization-regionCode.md)
...
* [Telecom Custodian](StructureDefinition-ehealth-organization-telecomCustodian.md)

* [Telecom System](StructureDefinition-ehealth-organization-telecomSystem.md)

* [Telecom Value](StructureDefinition-ehealth-organization-telecomValue.md)

* [Overview usage mode](StructureDefinition-ehealth-overviewUsageMode.md)

* [Participant](StructureDefinition-ehealth-participant.md)

* [Patient contact note](StructureDefinition-ehealth-patient-contactnote.md)

* [Performer](StructureDefinition-ehealth-performer.md)

* [Performing organization](StructureDefinition-ehealth-performing-organization.md)

* [Period](StructureDefinition-ehealth-period.md)

* [Predecessor](StructureDefinition-ehealth-predecessor.md)

* [Priority](StructureDefinition-ehealth-priority.md)

* [Date/time of re-used entity](StructureDefinition-ehealth-provenance-dateTimeOfReusedEntity.md)

* [Ehealth provider affiliation](StructureDefinition-ehealth-provider-affiliation.md)

* [Purpose](StructureDefinition-ehealth-purpose.md)
...
* [Feedback](StructureDefinition-ehealth-questionnaire-feedback.md)

* [Help text](StructureDefinition-ehealth-questionnaire-helpText.md)

* [Questionnaire image](StructureDefinition-ehealth-questionnaire-image.md)

* [Questionnaire intended organization](StructureDefinition-ehealth-questionnaire-intendedOrganization.md)

* [Copyright item indicator](StructureDefinition-ehealth-questionnaire-item-is-copyright.md)

* [Questionnaire recommendation](StructureDefinition-ehealth-questionnaire-recommendation.md)

* [Short text](StructureDefinition-ehealth-questionnaire-shortText.md)

* [Slider Step-value Decimal](StructureDefinition-ehealth-questionnaire-sliderStepValueDecimal.md)
...
* [CarePlan reference](StructureDefinition-ehealth-reference-careplan.md)

* [Reference range](StructureDefinition-ehealth-referenceRange.md)

* [Registration deadline](StructureDefinition-ehealth-registration-deadline.md)

* [Releasable resource](StructureDefinition-ehealth-releasableResource.md)

* [Resolved timing](StructureDefinition-ehealth-resolved-timing.md)

* [Responsible organization](StructureDefinition-ehealth-responsible-organization.md)

* [Responsible](StructureDefinition-ehealth-responsible.md)

* [Restriction category](StructureDefinition-ehealth-restriction-category.md)

* [Reuse criteria](StructureDefinition-ehealth-reuseCriteria.md)

* [Revision](StructureDefinition-ehealth-revision.md)
...
* [Status](StructureDefinition-ehealth-status.md)
...
* [Task responsible](StructureDefinition-ehealth-task-responsible.md)

* [Team history](StructureDefinition-ehealth-teamHistory.md)

* [Team schedule](StructureDefinition-ehealth-teamschedule.md)

* [Telecom purpose](StructureDefinition-ehealth-telecom-purpose.md)

* [Thread id](StructureDefinition-ehealth-thread-id.md)

* [Title](StructureDefinition-ehealth-title.md)

* [triggerEnablementCode](StructureDefinition-ehealth-trigger-enablement-code.md)

* [Trigger Condition](StructureDefinition-ehealth-triggerCondition.md)

* [Usage](StructureDefinition-ehealth-usage.md)

* [useContext](StructureDefinition-ehealth-useContext.md)

* [Version](StructureDefinition-ehealth-version.md)

* [View for](StructureDefinition-ehealth-view-for.md)

* [View type](StructureDefinition-ehealth-view-type.md)

* [VMR URI](StructureDefinition-ehealth-vmr-uri.md)

* [Interpreter required](StructureDefinition-patient-interpreterRequired.md)
