# library - eHealth Infrastructure v10.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/CapabilityStatement/library | *Version*:10.0.1 |
| Active as of 2026-08-03 | *Computable Name*:library |
...
```json
{
  ...
  "name" : "library",
  "status" : "active",
  "date" : "2026-08-03T02:22:22.823+00:00",
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "searchInclude" : ["*"],
      "searchRevInclude" : ["Library:composed-of",
      "Library:depends-on",
    ...
    },
    {
      ...
      },
      {
        ...
        "type" : "token",
        "documentation" : "Aggregation mode of the library"
      },
      {
        "name" : "composed-of",
        "type" : "reference",
    ...
    },
    {
      ...
      "definition" : "https://library.devtest.systematic-ehealth.com/fhir/OperationDefinition/-s-export-poll-status",
