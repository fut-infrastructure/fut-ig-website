# Resolve managing organization (data controller) - eHealth Infrastructure v10.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/Organization-t-resolve-managing-organization | *Version*:10.0.1 |
| Active as of 2026-08-11 | *Computable Name*:resolve-managing-organization |
