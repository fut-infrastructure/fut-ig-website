# MedCom Measurement CodeSystem - eHealth Infrastructure v10.0.0
...
| | |
| :--- | :--- |
| *Official URL*:urn:oid:1.2.208.184.100.8 | *Version*:10.0.0 |
...
```json
{
  ...
  {
    "code" : "MCS88050",
    "display" : "Rejse sætte sig testen(30 sek.);Pt",
    "definition" : "Pt—Rejse sætte sig testen; antal (værdi 0-50) (målt over 30 sekunder) =  × 1/30s",
    "designation" : [{
      "language" : "da",
      "use" : {
        "system" : "http://terminology.hl7.org/CodeSystem/hl7TermMaintInfra",
      ...
      "value" : "Rejse sætte sig testen(30 sek.)"
    },
    {
      "language" : "da",
      "use" : {
      ...
      "value" : "Rejse sætte sig testen(30 sek.);Pt"
    }],
    "property" : [{
      "code" : "phmr-unit",
      "valueString" : "1/30s"
  ...
  {
    "code" : "MCS88214",
    "display" : "Rejse sætte sig testen(60 sek.);Pt",
    "definition" : "Pt—Rejse sætte sig testen; antal (værdi 0-100) (målt over 60 sekunder) =  × 1/60s",
    "designation" : [{
      "language" : "da",
      "use" : {
        "system" : "http://terminology.hl7.org/CodeSystem/hl7TermMaintInfra",
      ...
      "value" : "Rejse sætte sig testen(60 sek.)"
    },
    {
      "language" : "da",
      "use" : {
      ...
      "value" : "Rejse sætte sig testen(60 sek.);Pt"
    }],
    "property" : [{
      "code" : "phmr-unit",
      "valueString" : "1/60s"
