# Quality history - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-devicemetric-qualityHistory | *Version*:10.0.2 |
| Active as of 2026-09-10 | *Computable Name*:ehealth-devicemetric-qualityHistory |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.ehealth.sundhed.fhir.ig.core|current/StructureDefinition/StructureDefinition-ehealth-devicemetric-qualityHistory.json)
