# View type - eHealth Infrastructure v10.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-view-type | *Version*:10.0.1 |
| Active as of 2026-08-11 | *Computable Name*:ehealth-view-type |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.ehealth.sundhed.fhir.ig.core|current/StructureDefinition/StructureDefinition-ehealth-view-type.json)
