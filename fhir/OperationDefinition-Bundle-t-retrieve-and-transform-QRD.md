# Retrieve and transform QRD document - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/Bundle-t-retrieve-and-transform-QRD | *Version*:10.0.2 |
| Active as of 2026-09-10 | *Computable Name*:retrieve-and-transform-QRD |
...
```json
{
  ...
  "parameter" : [{
    ...
    "min" : 1,
    "max" : "1",
    "documentation" : "This is the element DocumentReference.content.attachment.url for metadata about the QRD document as returned from the DocumentReference search operation performing a query to national document sharing infrastructure",
    "type" : "string",
    "searchType" : "uri"
  },
  {
    ...
    "min" : 1,
    "max" : "1",
    "documentation" : "This bundle must contain a Questionnaire FHIR resource corresponding to the questionnaire definition (QFDD) that the QRD references and is a response to",
    "type" : "Bundle"
  },
  {
