# ehealth-group-videoappointment - eHealth Infrastructure v10.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ehealth-group-videoappointment**

## Resource Profile: ehealth-group-videoappointment 

| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-group-videoappointment | *Version*:10.0.0 |
| Active as of 2026-08-06 | *Computable Name*:ehealth-group-videoappointment |
...
* Examples for this Profile: [Appointment/group-videoappointment01](Appointment-group-videoappointment01.md)
* CapabilityStatements using this Profile: [patient](CapabilityStatement-patient.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.ehealth.sundhed.fhir.ig.core|current/StructureDefinition/StructureDefinition-ehealth-group-videoappointment.json)
...
Other representations of profile: [CSV](StructureDefinition-ehealth-group-videoappointment.csv), [Excel](StructureDefinition-ehealth-group-videoappointment.xlsx), [Schematron](StructureDefinition-ehealth-group-videoappointment.sch) 
...
```json
{
  ...
  "url" : "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-group-videoappointment",
  "version" : "10.0.0",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-group-videoappointment"
      },
      {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-end-meeting-on-end-time"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-max-participants"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-meeting-url"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-vmr-uri"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-guest-pin-code"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-host-pin-code"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-creator"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-registration-deadline"]
      }]
    },
    {
    ...
    {
      "id" : "Appointment.serviceType:appointmentServiceType",
      "path" : "Appointment.serviceType",
    ...
    {
      "id" : "Appointment.serviceType:appointmentServiceType.coding",
    ...
    {
      "id" : "Appointment.serviceType:appointmentServiceType.coding.code",
      "path" : "Appointment.serviceType.coding.code",
      "min" : 1,
      "fixedCode" : "group-video"
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-assigning-careteam"]
      }]
    },
    {
