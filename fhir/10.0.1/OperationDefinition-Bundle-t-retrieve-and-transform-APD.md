# Retrieve and transform APD document - eHealth Infrastructure v10.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/Bundle-t-retrieve-and-transform-APD | *Version*:10.0.1 |
| Active as of 2026-08-11 | *Computable Name*:retrieve-and-transform-APD |
...
```json
{
  ...
  "parameter" : [{
    ...
    "min" : 1,
    "max" : "1",
    "documentation" : "This is the element DocumentReference.content.attachment.url for metadata about the APD document as returned from the DocumentReference search operation performing a query to national document sharing infrastructure",
    "type" : "string",
    "searchType" : "uri"
  },
  {
