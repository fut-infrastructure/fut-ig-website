# terminology - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/CapabilityStatement/terminology | *Version*:10.0.2 |
| Active as of 2026-08-02 | *Computable Name*:terminology |
...
```json
{
  ...
  "name" : "terminology",
  "status" : "active",
  "date" : "2026-08-02T18:24:23.473+00:00",
  ...
  "rest" : [{
    ...
    },
    {
      ...
      "definition" : "https://terminology.devtest.systematic-ehealth.com/fhir/OperationDefinition/-s-has-pending-work",
      "documentation" : "Check for pending work"
    },
    {
