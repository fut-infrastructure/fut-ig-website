# Execute practitioner stats - eHealth Infrastructure v10.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Execute practitioner stats**

## OperationDefinition: Execute practitioner stats 

| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-execute-practitioner-stats | *Version*:10.0.0 |
| Active as of 2026-08-06 | *Computable Name*:execute-practitioner-stats |
...
```json
{
  ...
  "url" : "http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-execute-practitioner-stats",
  "version" : "10.0.0",
