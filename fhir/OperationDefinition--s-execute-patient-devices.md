# Execute patient devices - eHealth Infrastructure v10.0.2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Execute patient devices**

## OperationDefinition: Execute patient devices 

| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-execute-patient-devices | *Version*:10.0.2 |
| Active as of 2026-09-10 | *Computable Name*:execute-patient-devices |
