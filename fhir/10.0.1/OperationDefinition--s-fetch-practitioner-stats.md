# Fetch practitioner stats - eHealth Infrastructure v10.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-fetch-practitioner-stats | *Version*:10.0.1 |
| Active as of 2026-08-11 | *Computable Name*:fetch-practitioner-stats |
...
```json
{
  ...
  "id" : "-s-fetch-practitioner-stats",
  "url" : "http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-fetch-practitioner-stats",
  "version" : "10.0.1",
  "name" : "fetch-practitioner-stats",
  "title" : "Fetch practitioner stats",
  "status" : "active",
  "kind" : "operation",
