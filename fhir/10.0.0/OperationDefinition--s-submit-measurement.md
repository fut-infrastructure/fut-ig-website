# Submit measurement - eHealth Infrastructure v10.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-submit-measurement | *Version*:10.0.0 |
| Active as of 2026-08-06 | *Computable Name*:submit-measurement |
...
```json
{
  ...
  "parameter" : [{
    ...
    "min" : 0,
    "max" : "1",
    "documentation" : "Bundle of 0..* Observation, 0..* QuestionnaireResponse, 0..* Media and 0..* Provenance.",
    "type" : "Bundle"
  },
  {
    "name" : "bundle",
