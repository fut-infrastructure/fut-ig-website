# Create a clone of a Questionnaire - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/Questionnaire-i-create-clone | *Version*:10.0.2 |
