# measurement - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/CapabilityStatement/measurement | *Version*:10.0.2 |
| Active as of 2026-08-03 | *Computable Name*:measurement |
...
```json
{
  ...
  "name" : "measurement",
  "status" : "active",
  "date" : "2026-08-03T02:27:22.268+00:00",
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "searchInclude" : ["*"],
      "searchRevInclude" : ["Communication:episodeOfCare",
    ...
    },
    {
      ...
      },
      {
        "name" : "policy",
        "type" : "uri",
        "documentation" : "Policy or plan the activity was defined by"
      },
      {
        "name" : "recorded",
        "type" : "date",
    ...
    },
    {
      ...
      "definition" : "https://measurement.devtest.systematic-ehealth.com/fhir/OperationDefinition/-s-export-poll-status",
