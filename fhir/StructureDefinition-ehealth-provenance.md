# ehealth-provenance - eHealth Infrastructure v10.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-provenance | *Version*:10.0.1 |
| Active as of 2026-08-11 | *Computable Name*:ehealth-provenance |
...
* Refer to this Profile: [Other item](StructureDefinition-ehealth-clinicalimpression-otherItem.md), [ehealth-servicerequest](StructureDefinition-ehealth-servicerequest.md) and [ehealth-task](StructureDefinition-ehealth-task.md)
* CapabilityStatements using this Profile: [careplan](CapabilityStatement-careplan.md), [measurement](CapabilityStatement-measurement.md), [organization](CapabilityStatement-organization.md) and [patient](CapabilityStatement-patient.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.ehealth.sundhed.fhir.ig.core|current/StructureDefinition/StructureDefinition-ehealth-provenance.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-provenance-dateTimeOfReusedEntity"]
      }]
    }]
  }
}
