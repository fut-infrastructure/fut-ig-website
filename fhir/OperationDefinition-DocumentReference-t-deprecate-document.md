# Deprecate document - eHealth Infrastructure v10.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/DocumentReference-t-deprecate-document | *Version*:10.0.0 |
| Active as of 2026-08-06 | *Computable Name*:deprecate-document |
...
```json
{
  ...
  "parameter" : [{
    ...
    "min" : 0,
    "max" : "1",
    "documentation" : "The documentIdentifier that makes up the masterIdentifier of the DocumentReference to deprecate.",
    "type" : "string",
    "searchType" : "token"
  },
  {
    ...
    "min" : 0,
    "max" : "1",
    "documentation" : "The cpr-number that makes up the masterIdentifier of the DocumentReference to deprecate.",
    "type" : "string",
    "searchType" : "string"
  }]
}
