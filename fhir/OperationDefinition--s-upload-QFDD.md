# Upload QFDD - eHealth Infrastructure v10.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-upload-QFDD | *Version*:10.0.1 |
| Active as of 2026-08-11 | *Computable Name*:upload-QFDD |
...
```json
{
  ...
  "parameter" : [{
    ...
    "min" : 0,
    "max" : "1",
    "documentation" : "A FHIR DocumentReference that contains the QFDD XML document to be uploaded.",
