# OIO BPP roles to eHealth CareTeam participant role mapping - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/ConceptMap/oio-bpp-roles-to-careteam-participant-roles | *Version*:10.0.2 |
