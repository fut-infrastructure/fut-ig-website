# Activitydefinition-code to measurement resource type - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/ConceptMap/activitydefinition-code-to-measurement-resource-type | *Version*:10.0.2 |
