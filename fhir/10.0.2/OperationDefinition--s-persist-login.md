# Persist login - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-persist-login | *Version*:10.0.2 |
| Active as of 2026-09-10 | *Computable Name*:persist-login |
