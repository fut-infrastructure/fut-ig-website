# Execute patient devices - eHealth Infrastructure v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-execute-patient-devices | *Version*:6.0.0 |
| Active as of 2025-10-23 | *Computable Name*:execute-patient-devices |
...
URL: [base]/$execute-patient-devices
