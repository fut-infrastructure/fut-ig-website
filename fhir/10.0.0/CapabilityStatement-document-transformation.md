# document-transformation - eHealth Infrastructure v10.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/CapabilityStatement/document-transformation | *Version*:10.0.0 |
| Active as of 2026-08-03 | *Computable Name*:document-transformation |
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-08-03T02:17:54.155+00:00",
  ...
  "rest" : [{
    ...
    },
    {
      ...
      "definition" : "https://document-transformation.devtest.systematic-ehealth.com/fhir/OperationDefinition/-s-export-poll-status",
