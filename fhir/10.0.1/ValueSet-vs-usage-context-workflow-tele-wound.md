# Usage Context for Tele Wound Workflow - eHealth Infrastructure v10.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/vs/usage-context-workflow-tele-wound | *Version*:10.0.1 |
...
* Included into [usageContextWorkflow](ValueSet-vs-usage-context-workflow.md)
