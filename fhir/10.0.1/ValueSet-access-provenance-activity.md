# AccessProvenance Activity - eHealth Infrastructure v10.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **AccessProvenance Activity**

## ValueSet: AccessProvenance Activity (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/vs/access-provenance-activity | *Version*:10.0.1 |
...
```json
{
  ...
  "url" : "http://ehealth.sundhed.dk/vs/access-provenance-activity",
  "version" : "10.0.1",
