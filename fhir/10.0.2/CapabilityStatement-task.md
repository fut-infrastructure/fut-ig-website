# task - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/CapabilityStatement/task | *Version*:10.0.2 |
| Active as of 2026-08-03 | *Computable Name*:task |
...
```json
{
  ...
  "name" : "task",
  "status" : "active",
  "date" : "2026-08-03T03:12:22.882+00:00",
