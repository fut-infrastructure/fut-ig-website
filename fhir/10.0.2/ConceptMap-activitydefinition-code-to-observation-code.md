# ActivityDefinition code to Observation code - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/ConceptMap/activitydefinition-code-to-observation-code | *Version*:10.0.2 |
