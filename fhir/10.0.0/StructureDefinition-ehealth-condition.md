# ehealth-condition - eHealth Infrastructure v10.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-condition | *Version*:10.0.0 |
| Active as of 2026-08-06 | *Computable Name*:ehealth-condition |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.ehealth.sundhed.fhir.ig.core|current/StructureDefinition/StructureDefinition-ehealth-condition.json)
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Condition.extension:codeQualification",
      "path" : "Condition.extension",
      "sliceName" : "codeQualification",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-code-qualification"]
      }]
    },
    {
      "id" : "Condition.code",
