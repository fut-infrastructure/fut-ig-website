# hapi.fhir.reindex-status - eHealth Infrastructure v10.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/OperationDefinition/-s-hapi.fhir.reindex-status | *Version*:10.0.0 |
| Active as of 2026-08-06 | *Computable Name*:hapi.fhir.reindex-status |
