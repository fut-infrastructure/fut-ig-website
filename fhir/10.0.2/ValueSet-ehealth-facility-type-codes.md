# Facility Type Codes - eHealth Infrastructure v10.0.2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Facility Type Codes**

## ValueSet: Facility Type Codes (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/vs/facility-type-codes | *Version*:10.0.2 |
| Active as of 2019-02-08 | *Computable Name*:FacilityTypeCodes |
...
```json
{
  ...
  "id" : "ehealth-facility-type-codes",
  "url" : "http://ehealth.sundhed.dk/vs/facility-type-codes",
  "version" : "10.0.2",
  "name" : "FacilityTypeCodes",
  "title" : "Facility Type Codes",
  "status" : "active",
  "experimental" : true,
