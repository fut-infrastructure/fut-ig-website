# document-query - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/CapabilityStatement/document-query | *Version*:10.0.2 |
| Active as of 2026-08-03 | *Computable Name*:document-query |
...
```json
{
  ...
  "name" : "document-query",
  "status" : "active",
  "date" : "2026-08-03T02:12:02.969+00:00",
  ...
  "rest" : [{
    ...
    {
      "name" : "expunge",
      "definition" : "https://document-query.devtest.systematic-ehealth.com/fhir/OperationDefinition/-s-expunge"
    }]
  }]
}
