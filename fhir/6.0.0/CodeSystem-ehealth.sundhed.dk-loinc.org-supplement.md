# LOINC Code System Supplement - eHealth Infrastructure v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/loinc.org/supplement | *Version*:6.0.0 |
...
This code system supplement `http://ehealth.sundhed.dk/loinc.org/supplement` defines displays on the following codes:
