# device - eHealth Infrastructure v10.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/CapabilityStatement/device | *Version*:10.0.1 |
| Active as of 2026-08-03 | *Computable Name*:device |
...
```json
{
  ...
  "name" : "device",
  "status" : "active",
  "date" : "2026-08-03T02:07:12.417+00:00",
