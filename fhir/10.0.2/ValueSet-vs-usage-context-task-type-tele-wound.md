# Usage Context for Tele Wound Task Type - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/vs/usage-context-task-type-tele-wound | *Version*:10.0.2 |
...
* Included into [Usage Context Task Type](ValueSet-vs-usage-context-task-type.md)
