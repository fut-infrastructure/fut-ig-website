# Sharing policy - eHealth Infrastructure v10.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-sharingPolicy | *Version*:10.0.0 |
| Active as of 2026-08-06 | *Computable Name*:ehealth-sharingPolicy |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.ehealth.sundhed.fhir.ig.core|current/StructureDefinition/StructureDefinition-ehealth-sharingPolicy.json)
