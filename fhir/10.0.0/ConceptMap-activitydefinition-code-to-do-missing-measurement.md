# Activitydefinition-code to do missing measurement - eHealth Infrastructure v10.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/ConceptMap/activitydefinition-code-to-do-missing-measurement | *Version*:10.0.0 |
