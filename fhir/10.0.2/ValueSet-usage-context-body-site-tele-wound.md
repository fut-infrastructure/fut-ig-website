# Usage Context for Tele Wound Body Site - eHealth Infrastructure v10.0.2
...
| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/vs/usage-context-body-site-tele-wound | *Version*:10.0.2 |
...
* Included into [Usage Context Body site](ValueSet-vs-usage-context-body-site.md)
