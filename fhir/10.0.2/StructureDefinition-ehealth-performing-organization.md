# Performing organization - eHealth Infrastructure v10.0.2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Performing organization**

## Extension: Performing organization 

| | |
| :--- | :--- |
| *Official URL*:http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-performing-organization | *Version*:10.0.2 |
| Active as of 2026-09-10 | *Computable Name*:ehealth-performing-organization |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.ehealth.sundhed.fhir.ig.core|current/StructureDefinition/StructureDefinition-ehealth-performing-organization.json)
...
Other representations of profile: [CSV](StructureDefinition-ehealth-performing-organization.csv), [Excel](StructureDefinition-ehealth-performing-organization.xlsx), [Schematron](StructureDefinition-ehealth-performing-organization.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-performing-organization"
    },
    {
